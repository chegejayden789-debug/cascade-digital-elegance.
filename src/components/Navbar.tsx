        ...
        <div className="container mx-auto flex items-center justify-between px-6 py-4">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <a
              ...
              className="bg-gold-gradient flex items-center gap-2 px-6 py-2.5 font-body text-xs font-semibold uppercase tracking-widest text-primary-foreground transition-all hover:opacity-90"
            >
        ...
        {mobileOpen && (
          ...
          >
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setMobileOpen(false)}
              className="bg-gold-gradient mt-4 flex items-center gap-3 px-10 py-4 font-body text-sm font-semibold uppercase tracking-widest text-primary-foreground"
            >
